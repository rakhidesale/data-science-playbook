# This is a comment
# To execute code/run command ctrl+Enter, alt+enter
...
Hello world! # will raise error
  
#This number is considered as a string "12345"
...
num = "20" #Value is stored as string because of quotation
...
#first letter of variable always be a character not a digit
#Only 2 special symbols are allowed _ and . (avoid using .)
2myvar = "s"
my-var = "s"
my var = "s"
_my_var = "s"
...
#Homogeneous vectors : Homogeneous data structures are ones that can only store a single type of data (numeric, integer, character, etc.). 
#vector of strings
...
# Heterogeneous Vectors : Heterogeneous data structures are ones that can store more than one type of data at the same time.
